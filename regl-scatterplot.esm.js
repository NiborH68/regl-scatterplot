import createPubSub from 'https://esm.sh/pub-sub-es@~3.0.0?target=es2022';
import createOriginalRegl from 'https://esm.sh/regl@~2.1.1?target=es2022';
...
const createScatterplot = (
    ...
    const raycast = () => {
        ...
        for (const pointIdx of pointsInBBox) {
            ...
            const d = dist(ptX * dataAspectRatio, ptY, xNdc * dataAspectRatio, yNdc);
            if (d < minDist) {
                minDist = d;
